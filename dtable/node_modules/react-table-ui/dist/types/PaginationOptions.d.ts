...
import type { UsePaginationOptions, UsePaginationState, UsePaginationInstanceProps } from './ReactTable';
import type { DataType, StateChangeHandler } from './DataType';
export declare type PaginationOptions<Data extends DataType> = ManualPaginationOptions<Data> | AutoPaginationOptions<Data>;
export interface ManualPaginationOptions<Data extends DataType> extends CommonPaginationOptions<Data> {
...
export interface AutoPaginationOptions<Data extends DataType> extends CommonPaginationOptions<Data> {
 ...
 * @category Options */
interface CommonPaginationOptions<Data extends DataType> extends UsePaginationOptions<Data> {
...
export declare type PaginationComponent<Data extends DataType> = FC<UsePaginationInstanceProps<Data> & UsePaginationState<Data> & {
    loading: boolean;
}>;

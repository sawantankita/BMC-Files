...
import type { UseFiltersOptions, UseFiltersState, FilterType, HeaderProps } from './ReactTable';
import type { DataType, StateChangeHandler } from './DataType';
/** Type interface for filtering options.
 * @category Options */
export interface FiltersOptions<Data extends DataType> extends UseFiltersOptions<Data> {
...
export declare type FilterComponent<Data extends DataType> = FC<HeaderProps<Data>>;
/** @category State */
export interface FiltersState<Data extends DataType> extends Partial<UseFiltersState<Data>> {

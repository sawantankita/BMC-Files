...
export interface SingleRowAction<Data extends DataType> extends CommonTableAction {
    /** Callback executed when action is clicked. */
    onClick: (data: Data, row: Row<Data>) => void;
}
export interface MultiRowAction<Data extends DataType> extends CommonTableAction {
    /** Callback executed when action is clicked. */

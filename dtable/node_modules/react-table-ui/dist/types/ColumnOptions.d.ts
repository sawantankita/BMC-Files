import type { IdType, UseColumnOrderState, UseResizeColumnsOptions, UseResizeColumnsState } from './ReactTable';
import type { DataType, StateChangeHandler } from './DataType';
/** Type interface for Column options.
 * @category Options */
export interface ColumnOptions<Data extends DataType> extends UseResizeColumnsOptions<Data> {
     ...
     *  The function must be wrapped in useCallback hook. */
    onVisibilityStateChange?: StateChangeHandler<ColumnState<Data>['hiddenColumns']>;
}
 ...
 * }
 */
export interface ColumnState<Data extends DataType> extends UseColumnOrderState<Data>, UseResizeColumnsState<Data> {

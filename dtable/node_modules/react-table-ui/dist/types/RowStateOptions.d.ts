import type { UseRowStateOptions, UseRowStateState, UseRowStateLocalState, Row, Cell } from './ReactTable';
import type { DataType, StateChangeHandler } from './DataType';
/** Type interface for RowState options.
 * @category Options */
export interface RowStateOptions<Data extends DataType> extends UseRowStateOptions<Data> {

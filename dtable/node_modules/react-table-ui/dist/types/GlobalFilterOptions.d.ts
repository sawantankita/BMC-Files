...
import type { UseGlobalFiltersOptions, UseGlobalFiltersState, FilterType, Row, IdType, UseGlobalFiltersInstanceProps } from './ReactTable';
import type { DataType, StateChangeHandler } from './DataType';
/** Type interface for filtering options.
 * @category Options */
export interface GlobalFilterOptions<Data extends DataType> extends UseGlobalFiltersOptions<Data> {
...
export declare type GlobalFilterComponent<Data extends DataType> = FC<UseGlobalFiltersInstanceProps<Data> & {

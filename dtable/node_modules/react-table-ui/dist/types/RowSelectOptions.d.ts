...
import type { UseRowSelectOptions, UseRowSelectState, TableToggleCommonProps, IdType } from './ReactTable';
import type { DataType, StateChangeHandler } from './DataType';
/** Type interface for RowSelect options.
 * @category Options */
export interface RowSelectOptions<Data extends DataType> extends UseRowSelectOptions<Data> {
...
export declare type RowSelectComponent = FC<TableToggleCommonProps>;
